...
otherLanguages:
  - text: 繁體中文版
    path: https://andy23512.com/blog-zh-tw/tangent-的最新和弦列表/
---
{% blockquote %}
...
|c+o+n|container|"container" is a frequently used word in my FSE work.|
...
|d+j|django|[Django](https://www.djangoproject.com/) is a web framework I use in my FSE work.|
...
|f+n|frontend|Frontend is a frequently used word in my FSE works.|
...
|p+n|preference|"preference" is a frequently used word in my FSE work.|
...
|Input|Output|Description|
|-|-|-|
|a+n|angular|[Angular](https://angular.dev/) is an frontend framework I use in my FSE work.|
