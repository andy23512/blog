...
alias:
  - /2024/11/11/tangent-s-usages-of-chording/
  - /2024/11/12/tangent-s-usages-of-chording/
  - /2024/11/13/tangent-s-usages-of-chording/
  - /2024/11/14/tangent-s-usages-of-chording/
  - /2024/11/15/tangent-s-usages-of-chording/
otherLanguages:
  - text: 繁體中文版
    path: https://andy23512.com/blog-zh-tw/tangent-的和弦用法/
---
...
{% blockquote %}
I have <a href="{% post_path tangent-s-introduction-to-bopomofo-chord %}">another article about Bopomofo chords</a>.
{% endblockquote %}

### CC1 Chord

{% blockquote %}
I list my CC1 chords in <a href="{% post_path tangent-s-latest-chord-list %}">this note</a>.
{% endblockquote %}
...
An example in <a href="{% post_path tangent-s-layout-for-using-bopomofo-chinese-input-method-with-charachorder-one %}#V5-Latest">TC41.V5</a>, `e+x -> exit` is not a conflicting CC1 chord, because the corresponding Bopomofo symbols of `e` and `x` are `ㄑ` and `ㄡ`, and `ㄑㄡ` is not a valid Bopomofo combination.
